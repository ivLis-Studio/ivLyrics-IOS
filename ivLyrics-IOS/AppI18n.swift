...
enum AppI18n {
    ...
    private static let extraStrings: [String: [String: String]] = [
        "ko": [
            ...
            "openai.connections": "추가 OpenAI 호환 제공자",
            "openai.connections_desc": "기본 연결이 실패하면 활성화된 추가 제공자를 순서대로 시도합니다.",
            "openai.add_connection": "커스텀 제공자 추가",
            "openai.connection_name": "제공자 이름",
            "openai.remove_connection": "제공자 삭제",
            "openai.move_up": "우선순위 올리기",
            "openai.move_down": "우선순위 내리기",
            "status.models_builtin_sonar": "Sonar는 모델 목록 API가 없어 기본 지원 목록을 표시합니다.",
        ...
        "en": [
            ...
            "openai.connections": "Additional OpenAI-compatible providers",
            "openai.connections_desc": "If the primary connection fails, try enabled additional providers in order.",
            "openai.add_connection": "Add custom provider",
            "openai.connection_name": "Provider name",
            "openai.remove_connection": "Remove provider",
            "openai.move_up": "Move up",
            "openai.move_down": "Move down",
            "status.models_builtin_sonar": "Sonar has no model list API. Showing its built-in supported models.",
