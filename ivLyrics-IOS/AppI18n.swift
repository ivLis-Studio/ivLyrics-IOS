...
enum AppI18n {
    ...
    private static let extraStrings: [String: [String: String]] = [
        "ko": [
            ...
            "section.spotify_api_option_desc": "Client ID만 있으면 설치된 Spotify 앱을 App Remote로 연결해 현재 곡 가사를 표시합니다. Spotify Web API는 선택 기능이며, 켜면 다음 곡 대기열을 미리 불러오고 App Remote가 연결되지 않을 때 보조 경로로 사용합니다.",
            "spotify.api.desc_option": "Client ID는 App Remote 연결에 필요합니다. Client Secret은 ISRC와 메타데이터 보강용 선택 항목이며, 대기열은 읽지 못합니다. 다음 곡 미리 준비가 필요하면 아래에서 Spotify Web API를 켜세요.",
            "spotify.live.desc_option": "iOS 공개 API는 다른 앱의 재생 정보를 읽을 수 없습니다. ivLyrics는 Spotify App Remote로 현재 곡을 받아옵니다. Spotify Web API를 켜면 다음 곡 대기열까지 미리 준비하고, App Remote 연결이 안 될 때 보조 경로로 전환합니다.",
            "field.spotify_client_secret_role": "선택 항목입니다. 로그인 없이 ISRC와 메타데이터를 보강할 때만 사용하며, 재생 대기열은 읽을 수 없습니다.",
            "setting.spotify_web_api": "Spotify Web API 사용",
            "setting.spotify_web_api_desc": "켜면 재생 대기열의 다음 곡 가사와 번역을 미리 준비하고, App Remote가 연결되지 않을 때 보조 재생 정보로 사용합니다. 처음 켤 때 Spotify 웹 로그인 화면이 한 번 표시됩니다. 끄면 App Remote로 현재 곡 가사는 계속 표시되고 웹 로그인은 하지 않습니다.",
            "setting.spotify_web_api_status_off": "꺼짐 · App Remote로 현재 곡 가사만 표시하며 웹 로그인을 하지 않습니다.",
            "setting.spotify_web_api_status_connected": "Spotify 계정 연결됨 · 다음 곡 미리 준비를 사용할 수 있습니다.",
            "setting.spotify_web_api_status_pending": "Spotify Live를 연결할 때 웹 로그인이 한 번 진행됩니다.",
            "spotify.disconnect_oauth_desc": "저장된 Spotify 로그인 정보를 삭제하고 Spotify Live 연결을 중지합니다. 설정을 끄는 것만으로는 삭제되지 않습니다.",
            ...
            "research.font_decrease": "글자 작게",
            "research.font_increase": "글자 크게",
            "onboarding.welcome_title": "ivLyrics 설정 시작",
            "onboarding.subtitle_ios": "Spotify 재생 정보에 맞춰 가사와 싱크를 자동으로 불러옵니다.",
        ...
        "en": [
            ...
            "section.spotify_api_option_desc": "A Client ID alone connects the installed Spotify app through App Remote and shows lyrics for the current song. Spotify Web API is optional; turning it on prefetches the next queued song and acts as a fallback when App Remote cannot connect.",
            "spotify.api.desc_option": "The Client ID is required for App Remote. The Client Secret is optional for ISRC and metadata enrichment and cannot read the playback queue. Turn on Spotify Web API below if you want the next song prepared in advance.",
            "spotify.live.desc_option": "iOS public APIs cannot read playback from other apps, so ivLyrics uses Spotify App Remote for the current song. Turning on Spotify Web API also prepares the next queued song and provides a fallback when App Remote cannot connect.",
            "field.spotify_client_secret_role": "Optional. Used only for login-free ISRC and metadata enrichment; it cannot read the playback queue.",
            "setting.spotify_web_api": "Use Spotify Web API",
            "setting.spotify_web_api_desc": "Prefetches lyrics and translations for the next song in your playback queue and serves as a fallback when App Remote cannot connect. A Spotify web login appears once when you first enable it. When off, App Remote keeps showing lyrics for the current song and no web login happens.",
            "setting.spotify_web_api_status_off": "Off · App Remote still shows lyrics for the current song and no web login occurs.",
            "setting.spotify_web_api_status_connected": "Spotify account connected · next-song prefetch is available.",
            "setting.spotify_web_api_status_pending": "A one-time web login runs when you connect Spotify Live.",
            "spotify.disconnect_oauth_desc": "Removes the saved Spotify login and stops Spotify Live. Turning the setting off does not delete it.",
            ...
            "tmi.no_data": "No Research result is available.",
            ...
            "research.font_decrease": "Decrease text size",
            "research.font_increase": "Increase text size",
            "onboarding.welcome_title": "Set Up ivLyrics",
            "onboarding.subtitle_ios": "Lyrics and sync data load automatically from your Spotify playback.",
            "onboarding.step_format": "Step %d / %d",
            ...
            "onboarding.preview.line4": "Tap the title or artist to jump back to Spotify.",
