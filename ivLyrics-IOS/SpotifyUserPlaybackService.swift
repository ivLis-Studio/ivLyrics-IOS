...
final class SpotifyUserPlaybackService: NSObject, ObservableObject, ASWebAuthenticationPresentationContextProviding {
    ...
    func nextQueuedTrack(clientId: String, excludingSourceKey: String = "") async -> TrackSnapshot? {
        ...
        case .parseBody:
            ...
            case .emptyQueue:
                ...
                return nil
            case .unsupportedItem:
                diagnostic("spotify queue prefetch stopped: queue has no distinct usable track")
                return nil
            case .malformedResponse:
